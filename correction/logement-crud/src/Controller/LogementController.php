...
namespace App\Controller {
    ...
    {
        private function verifierPayload(array $data, array $file): ?string
        {
        ...
        private function verifierPayloadPourModification(array $data): ?string
        {
            if (!isset($data['logement-name']) || $data['logement-name'] === '') {
                return "Vous devez spécifier un nom de logement";
            }
        ...
        private function convertirPayloadEnObjet(array $data, array $file): Logement
        {
